...
//        cardImg17.getLayoutParams().height = height;
        ...
        final ImageView[] viewList = new ImageView[7];
        viewList[0]=pileImg1;
        viewList[1]=pileImg2;
        viewList[2]=pileImg3;
        viewList[3]=pileImg4;
...
//        for(i = 0;i<6;i++){
//            ViewTreeObserver vto = viewList[i].getViewTreeObserver();
//            vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener(){
//                public void onGlobalLayout(){
//                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
//                        viewList[i].getViewTreeObserver().removeOnGlobalLayoutListener(this);
//                    }
//                    if(i>0&&i<4){
//                        viewList[i].setX(viewList[i-1].getX()+marginX);
//                        viewList[i].setY(viewList[i-1].getY());
//                    }
//                    else if(i>=4){
//                        viewList[i].setX(viewList[i-4].getX());
//                        viewList[i].setY(viewList[i-4].getY()+marginY);
//                    }
//                    pileList[i] = new Pile(new Point((int)viewList[i].getX(), (int)viewList[i].getY()));
//                }
//            });
//        }
        ...
        vtoC1.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card1 = new Card(pileList[0],cardImg1,1, Card.Suit.Club, R.drawable.club1);
            }
        });
        ...
        vtoC2.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card2 = new Card(pileList[3],cardImg2,2, Card.Suit.Diamond, R.drawable.diamond2);
            }
        });
        ...
        vtoC3.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card3 = new Card(pileList[6],cardImg3,3, Card.Suit.Heart, R.drawable.heart3);
            }
        });
        ...
        vtoC4.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card4 = new Card(pileList[3],cardImg4,4, Card.Suit.Spade, R.drawable.spade4);
            }
        });
        ...
        vtoC5.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card5 = new Card(pileList[6],cardImg5,5, Card.Suit.Heart, R.drawable.heart5);
            }
        });
        ...
        vtoC6.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card6 = new Card(pileList[0],cardImg6,6, Card.Suit.Diamond, R.drawable.diamond6);
            }
        });
        ...
        vtoC7.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card7 = new Card(pileList[6],cardImg7,7, Card.Suit.Club, R.drawable.club7);
            }
        });
        ...
        vtoC8.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card8 = new Card(pileList[3],cardImg8,8, Card.Suit.Diamond, R.drawable.diamond8);
            }
        });
        ...
        vtoC9.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card9 = new Card(pileList[3],cardImg9,9, Card.Suit.Heart, R.drawable.heart9);
            }
        });
        ...
        vtoC10.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card10 = new Card(pileList[0],cardImg10,10, Card.Suit.Spade, R.drawable.spade10);
            }
        });
        ...
        vtoC11.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card11 = new Card(pileList[6],cardImg11,11, Card.Suit.Heart, R.drawable.heart11);
            }
        });
        ...
        vtoC12.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card12 = new Card(pileList[0],cardImg12,12, Card.Suit.Diamond, R.drawable.diamond12);
            }
        });
        ...
        vtoC13.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card13 = new Card(pileList[3],cardImg13,13, Card.Suit.Club, R.drawable.club13);
                card13.openCard();
            }
        });
        ...
        vtoC14.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card14 = new Card(pileList[0],cardImg14,2, Card.Suit.Spade, R.drawable.spade2);
            }
        });
        ...
        vtoC15.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card15 = new Card(pileList[0],cardImg15,3, Card.Suit.Club, R.drawable.club3);
            }
        });
        ...
        vtoC16.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card16 = new Card(pileList[6],cardImg16,5, Card.Suit.Club, R.drawable.club5);
                card16.openCard();
            }
        });
...
//        });
        ...
        vtoC18.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card18 = new Card(pileList[0],cardImg18,6, Card.Suit.Club, R.drawable.club6);
                card18.openCard();
            }
        });
        ...
        vtoC19.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Card card19 = new Card(pileList[3],cardImg19,12, Card.Suit.Spade, R.drawable.spade12);
                card19.openCard();
            }
        });
